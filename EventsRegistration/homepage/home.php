...
<body>
    <div class="header-container">
        <div class="userlogo"><img src="../img/user.png" alt="User Logo"></div>
        ...
        <ul>
            <?php if (!empty($recent_events)): ?>
                <?php foreach ($recent_events as $event): ?>
                    <li>
                        <?php echo htmlspecialchars($event['title']); ?> - <?php echo htmlspecialchars($event['date']); ?>
                    </li>
                <?php endforeach; ?>
            <?php else: ?>
    ...
    <div class="upcoming-events">
        ...
        <ul>
            <?php foreach ($events as $event): ?>
                <?php 
                    $is_registered = in_array($event['title'], array_column($registered_events, 'event_title'));
                    $deadline_passed = (strtotime($event['deadline']) < time());
                ?>
                <?php if (!$is_registered && !$deadline_passed): ?>
                    <li>
                        <?php echo htmlspecialchars($event['title']); ?> - <?php echo htmlspecialchars($event['deadline']); ?>
                        <button onclick="showRegistrationForm('<?php echo $event['title']; ?>')">Register</button>
                    </li>
                <?php endif; ?>
            <?php endforeach; ?>
