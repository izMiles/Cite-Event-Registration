...
<body>
    <div class="header-container">
        <div class="userlogo"><img src="../img/admin.png" alt="Admin Logo"></div>
    ...
    <div class="event-list main-display">
        <table>
            ...
            <?php foreach ($events as $event): ?>
                <tr>
                    <td><a href="?event=<?php echo urlencode($event['title']); ?>"><?php echo htmlspecialchars($event['title']); ?></a></td>
                    <td><?php echo htmlspecialchars($event['date']); ?></td>
                    <td><?php echo htmlspecialchars($event['deadline']); ?></td>
                    <td>
                        <button class="remove-event-btn" onclick="removeEvent('<?php echo $event['title']; ?>')">Remove</button>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
    ...
    <script>
        ...
        function removeEvent(eventTitle) {
            ...
            if (userInput === eventTitle) {
                ...
                alert("Event title does not match. Event not removed.");
            }
        }
